<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminComments.aspx.cs" Inherits="AdminComments" %>
...
<div id="main">
  ...
  <center> 
    ...
    <center>   <asp:Label ID="Label1" runat="server" Text="COMMENTS CONTROL" Font-Underline="true" Font-Size="X-Large" ForeColor="#CCCCCC"></asp:Label></center> 
        <br>
        <br>
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="SqlDataSource1" Width="859px" Height="573px" PageSize="20" >
          <Columns>
              ...
              <asp:BoundField DataField="UserName" HeaderStyle-HorizontalAlign="Justify" HeaderText="UserName" SortExpression="UserName" HeaderStyle-Height="30" HeaderStyle-Font-Bold="false" HeaderStyle-Font-Size="Larger" />
              <asp:BoundField DataField="Subject" HeaderStyle-HorizontalAlign="Justify" HeaderText="Subject" SortExpression="Subject" HeaderStyle-Height="30" HeaderStyle-Font-Bold="false" HeaderStyle-Font-Size="Larger" />
              <asp:BoundField DataField="Comment" HeaderStyle-HorizontalAlign="Justify" HeaderText="Comment" SortExpression="Comment" HeaderStyle-Height="30" HeaderStyle-Font-Bold="false" HeaderStyle-Font-Size="Larger" />
